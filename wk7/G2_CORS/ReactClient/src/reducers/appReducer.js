...
const appReducer = (state, action) => {
  switch (action.type) {
    ...
    case actionType.USER_SIGNIN_SUCCESS:
      return { ...state, userSignin: { ...state.userSignin, loading: false, userInfo: action.payload}};
    case actionType.USER_SIGNIN_FAIL:
      return { ...state, userSignin: { ...state.userSignin, loading: false, error: action.payload}};
